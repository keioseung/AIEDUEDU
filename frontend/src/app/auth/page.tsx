      ...
      <div className="relative z-10 flex items-center justify-center min-h-screen px-4 py-20 md:py-32">
        <div className="w-full max-w-md">
           ...
           <div className="absolute top-4 left-4 z-20">
             <button
               onClick={() => router.push('/')}
               className="w-10 h-10 bg-white/10 backdrop-blur-sm rounded-full text-white/80 hover:text-white hover:bg-white/20 transition-all duration-300 border border-white/20 hover:border-white/40 flex items-center justify-center hover:scale-110 active:scale-95"
             >
